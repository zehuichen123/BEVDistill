...
class DeformableDetrTransformerV2(DeformableDetrTransformer):
    def forward(self,
                mlvl_feats,
                mlvl_masks,
                query_embed,
        ...
        if self.as_two_stage:
            return inter_states, init_reference_out,\
                ...
                enc_outputs_coord_unact
        return inter_states, init_reference_out, \
            inter_references_out, None, None, bev_outputs
...
def feature_sampling(mlvl_feats, reference_points, pc_range, img_metas):
    ...
    for img_meta in img_metas:
        #print('lidar2img', img_meta['lidar2img'])
    ...
    # print('reference_points_cam', reference_points_cam.shape)   [1, 6,  900, 4]
    # print(reference_points_cam[..., 2:3])
    eps = 1e-5
    ...
    mask = torch.nan_to_num(mask)
    # print(mask.shape, mask.sum()) 900/5400 个点被保留
    sampled_feats = []
