...
class PredDistiller(BaseDetector):
    ...
    def __init__(self,
        ...
        super(PredDistiller, self).__init__()
    ...
    def forward_train(self, img, img_metas, **kwargs):
        ...
        student_out = self.student.forward_train(img=img, img_metas=img_metas, **kwargs, return_pred=True, return_weight=self.use_student_assign)
