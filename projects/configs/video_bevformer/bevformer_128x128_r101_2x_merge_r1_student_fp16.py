...
model = dict(
    ...
    img_backbone=dict(
        ...
        norm_eval=True,
        style='caffe',
        dcn=dict(type='DCNv2_silent', deform_groups=1, fallback_on_stride=False), # original DCNv2 will print log when perform load_state_dict
...
# load_from = 'data/pretrain_models/fcos3d_r50_new.pth'
# log_config = dict(
#     interval=50,
#     hooks=[
